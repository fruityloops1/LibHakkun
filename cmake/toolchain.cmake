...
if (${APPLE})
    if (${CMAKE_SYSTEM_PROCESSOR} STREQUAL "aarch64")
        ...
        set(CLANG_PREFIX "/opt/homebrew/opt/llvm/bin/")
    elseif (${CMAKE_SYSTEM_PROCESSOR} STREQUAL "x86_64")
        if (NOT EXISTS "/usr/local/opt/llvm/bin/")
            message(FATAL_ERROR "LLVM not installed! Please install llvm with brew")
        endif()
        set(CLANG_PREFIX "/usr/local/opt/llvm/bin/")
    endif()
endif()
...
set(CMAKE_RANLIB "${CLANG_PREFIX}llvm-ranlib")
set(CMAKE_AR "${CLANG_PREFIX}llvm-ar")
