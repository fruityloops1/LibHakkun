...
if (${APPLE})
    if (${CMAKE_SYSTEM_PROCESSOR} STREQUAL "aarch64")
        if (NOT EXISTS "/opt/homebrew/opt/llvm/bin/")
            message(FATAL_ERROR "LLVM not installed! Please install llvm with brew")
        endif()
        set(LLVM_PREFIX "/opt/homebrew/opt/llvm/bin/")
    elseif (${CMAKE_SYSTEM_PROCESSOR} STREQUAL "x86_64")
        if (NOT EXISTS "/usr/local/opt/llvm/bin/")
            message(FATAL_ERROR "LLVM not installed! Please install llvm with brew")
        endif()
        set(LLVM_PREFIX "/usr/local/opt/llvm/bin/")
    endif()
endif()

set(CMAKE_SYSTEM_VERSION "${CMAKE_SYSTEM_NAME}/Clang")
set(CMAKE_ASM_COMPILER "${LLVM_PREFIX}clang")
set(CMAKE_C_COMPILER "${LLVM_PREFIX}clang")
set(CMAKE_CXX_COMPILER "${LLVM_PREFIX}clang++")
set(CMAKE_RANLIB "${LLVM_PREFIX}llvm-ranlib")
set(CMAKE_AR "${LLVM_PREFIX}llvm-ar")
...
string(REPLACE ";" " " DEFAULTDEFINES "${DEFAULTDEFINES}")
set(ARCH_FLAGS "${ARCH_FLAGS} ${DEFAULTDEFINES}")
