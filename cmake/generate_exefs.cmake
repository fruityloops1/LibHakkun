function(generate_exefs)
    ...
    add_custom_command(TARGET ${PROJECT_NAME} POST_BUILD
        ...
        COMMAND python ${CMAKE_SOURCE_DIR}/sys/tools/senobi/build_npdm.py ${CMAKE_CURRENT_BINARY_DIR}/npdm.json ${CMAKE_CURRENT_BINARY_DIR}/main.npdm 2>> ${CMAKE_CURRENT_BINARY_DIR}/npdm.log
    )
