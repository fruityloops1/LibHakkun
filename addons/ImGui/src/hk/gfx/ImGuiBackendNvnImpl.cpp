...
namespace hk::gfx {
    ...
    void ImGuiBackendNvnImpl::initBuffers(size vertSize, size idxSize) {
    ...
    void ImGuiBackendNvnImpl::initTexture(bool useLinearFilter) {
        auto& io = ImGui::GetIO();
    ...
    void ImGuiBackendNvnImpl::initialize() {
    ...
    void ImGuiBackendNvnImpl::bindTexture(nvn::CommandBuffer* cmdBuffer, const TextureHandle& tex) {
    ...
    void ImGuiBackendNvnImpl::setDrawState(nvn::CommandBuffer* cmdBuffer) {
