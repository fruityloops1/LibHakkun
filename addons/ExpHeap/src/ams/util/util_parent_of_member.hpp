...
#pragma pack(pop)
        ...
        template <auto MemberPtr, typename RealParentType = GetParentType<MemberPtr>>
            requires(std::derived_from<RealParentType, GetParentType<MemberPtr>> || std::same_as<RealParentType, GetParentType<MemberPtr>>)
        ...
        struct OffsetOfCalculatorTheSadWayForClangSupport {
            static hk_alwaysinline std::ptrdiff_t Calculate() {
                const union Union {
                    ParentType p;
                    char c;
    ...
    hk_alwaysinline RealParentType& GetParentReference(impl::GetMemberType<MemberPtr>* member) {
    ...
    template <auto MemberPtr, typename RealParentType = impl::GetParentType<MemberPtr>>
    const hk_alwaysinline RealParentType& GetParentReference(const impl::GetMemberType<MemberPtr>* member) {
        /* TODO: If clang resolves compiler-bugs in consteval (or if my std proposal makes it into a future C++ standard), we should go back to constexpr. */
        const std::ptrdiff_t Offset = impl::OffsetOfCalculatorTheSadWayForClangSupport<RealParentType, impl::GetMemberType<MemberPtr>, MemberPtr>::Calculate();
    ...
    template <auto MemberPtr, typename RealParentType = impl::GetParentType<MemberPtr>>
    hk_alwaysinline RealParentType* GetParentPointer(impl::GetMemberType<MemberPtr>* member) {
        return std::addressof(GetParentReference<MemberPtr, RealParentType>(member));
    }

    template <auto MemberPtr, typename RealParentType = impl::GetParentType<MemberPtr>>
    const hk_alwaysinline RealParentType* GetParentPointer(const impl::GetMemberType<MemberPtr>* member) {
        return std::addressof(GetParentReference<MemberPtr, RealParentType>(member));
    }
