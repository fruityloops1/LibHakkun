...
namespace hk::ro {
    ...
    hk_pure size getNumModules();
    hk_const RoModule* getModuleByIndex(int idx);
    ...
    hk_pure ptr lookupSymbol(const char* symbol);
    hk_pure ptr lookupSymbol(uint64_t bucketHash, uint32_t djb2Hash, uint32_t murmurHash);
